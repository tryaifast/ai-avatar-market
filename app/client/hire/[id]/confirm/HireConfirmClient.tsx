...
export default function HireConfirmClient({ avatarId }: { avatarId: string }) {
  ...
  const totalAmount = plan === 'hourly' 
    ? avatar.hourlyPrice * hours 
    : avatar.fixedPrice;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              ...
              <div className="flex items-center gap-4">
                <div className="avatar avatar-lg">{avatar.avatarUrl}</div>
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm mt-1">
                    ...
                    <span>{avatar.completedProjects} 个完成项目</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <label className={`p-4 rounded-lg border-2 cursor-pointer block transition-colors ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">¥{avatar.hourlyPrice}/小时</span>
                  </div>
                </label>
                ...
                <label className={`p-4 rounded-lg border-2 cursor-pointer block transition-colors ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold">¥{avatar.fixedPrice} 起</span>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="card sticky top-24">
              ...
              <div className="space-y-3 text-sm mb-4">
                <div className="flex justify-between">
                  ...
                  <span>¥{plan === 'hourly' ? `${avatar.hourlyPrice}/小时` : avatar.fixedPrice}</span>
                </div>
                <div className="flex justify-between">
